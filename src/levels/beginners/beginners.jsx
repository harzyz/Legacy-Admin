...
export default function Beginners({ id }) {
  ...
  return (
    <section className={styles.Beginners_Container}>
      ...
      {filterType === "Exercise" && (
        <Exercise day={id} level='beginners' activity={activity} setActivity={setActivity} />
      )}
      {filterType === "Moves" && (
        <Moves day={id} level='beginners' activity={activity} setActivity={setActivity} />
      )}
      {filterType === "Drills" && (
        <Drills day={id} level='beginners' activity={activity} setActivity={setActivity} />
      )}
    </section>
  );
}
