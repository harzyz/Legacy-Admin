...
export default function Intermediate({id}) {
  ...
  return (
    <section className={styles.Beginners_Container}>
      ...
      {filterType === "Exercise" && (
        <Exercise day={id} level='intermediate' activity={activity} setActivity={setActivity} />
      )}
      {filterType === "Moves" && (
        <Moves day={id} level='intermediate' activity={activity} setActivity={setActivity} />
      )}
      {filterType === "Drills" && (
        <Drills day={id} level='intermediate' activity={activity} setActivity={setActivity} />
      )}
    </section>
  );
}
